...
if __name__ == '__main__':
    ...
    # copy .npy
    src_path = 'light_y_annual/'
    tar_path_list = ['dataset_0604/train/light_cnn_img/', 'dataset_0604/test/light_cnn_img/', 'dataset_0604/valid/light_cnn_img/']

    for file in os.listdir(src_path):
        for tar_path in tar_path_list:
            src_file = src_path + file
            dst_file = tar_path + file
